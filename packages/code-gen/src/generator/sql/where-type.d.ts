 ...
 */
export function getWherePartial(context: CodeGenContext, imports: any, type: CodeGenObjectType): string;
/**
 ...
 */
export function getSearchableFields(type: CodeGenObjectType): Record<string, CodeGenType>;
